...
l8_1, = ax.plot([], [], 'g-', lw=2)
l9_1, = ax.plot([], [], 'g-', lw=2)
l10_1, = ax.plot([], [], 'g-', lw=2) 
l11_1, = ax.plot([], [], 'g-', lw=2)
l12_1, = ax.plot([], [], 'g-', lw=2)
l13_1, = ax.plot([], [], 'g-', lw=2)        
l14_1, = ax.plot([], [], 'g-', lw=2)
l15_1, = ax.plot([], [], 'g-', lw=2)
l16_1, = ax.plot([], [], 'g-', lw=2)
l17_1, = ax.plot([], [], 'g-', lw=2) 
l18_1, = ax.plot([], [], 'g-', lw=2)
l19_1, = ax.plot([], [], 'g-', lw=2)
l20_1, = ax.plot([], [], 'g-', lw=2) 
l21_1, = ax.plot([], [], 'g-', lw=2)
l22_1, = ax.plot([], [], 'g-', lw=2)
l23_1, = ax.plot([], [], 'g-', lw=2)        
l24_1, = ax.plot([], [], 'g-', lw=2)
l25_1, = ax.plot([], [], 'g-', lw=2)
l26_1, = ax.plot([], [], 'g-', lw=2)
l27_1, = ax.plot([], [], 'g-', lw=2) 
l28_1, = ax.plot([], [], 'g-', lw=2)
l29_1, = ax.plot([], [], 'g-', lw=2)
l30_1, = ax.plot([], [], 'g-', lw=2) 
l31_1, = ax.plot([], [], 'g-', lw=2)
l32_1, = ax.plot([], [], 'g-', lw=2)
l33_1, = ax.plot([], [], 'g-', lw=2)        
l34_1, = ax.plot([], [], 'g-', lw=2)
l35_1, = ax.plot([], [], 'g-', lw=2)
l36_1, = ax.plot([], [], 'g-', lw=2)
l37_1, = ax.plot([], [], 'g-', lw=2) 
l38_1, = ax.plot([], [], 'g-', lw=2)
l39_1, = ax.plot([], [], 'g-', lw=2)
l40_1, = ax.plot([], [], 'g-', lw=2) 


for i in range(int(9)):
    x = (5*np.sin(t)+ 65/2*np.cos(2*i*np.pi/9))
    y = (5*np.cos(t) + 65/2*np.sin(2*i*np.pi/9))
    if i == 0:
        l0_1, = ax.plot(x, y,'g-')
    if i == 1:
        l1_1, = ax.plot(x, y,'g-')
...
def pin1_update_1(n1,n2,d,D,phi):
    for i in range(int(n1)):   
        #x = (d/2*np.sin(t)+ D/2*np.cos(2*i*np.pi/n))
        #y = (d/2*np.cos(t) + D/2*np.sin(2*i*np.pi/n))
        #x = (d/2*np.sin(t)+ D/2*np.cos(2*i*np.pi/n))*np.cos(np.pi) - (d/2*np.cos(t) + D/2*np.sin(2*i*np.pi/n))*np.sin(np.pi)
        #y = (d/2*np.sin(t)+ D/2*np.cos(2*i*np.pi/n))*np.sin(np.pi) + (d/2*np.cos(t) + D/2*np.sin(2*i*np.pi/n))*np.cos(np.pi)
        x = (d/2*np.sin(t)+ D/2*np.cos(2*i*np.pi/n1))*np.cos(phi/(n1*(n2-1))+np.pi/n1) - (d/2*np.cos(t) + D/2*np.sin(2*i*np.pi/n1))*np.sin(phi/(n1*(n2-1))+np.pi/n1)
        y = (d/2*np.sin(t)+ D/2*np.cos(2*i*np.pi/n1))*np.sin(phi/(n1*(n2-1))+np.pi/n1) + (d/2*np.cos(t) + D/2*np.sin(2*i*np.pi/n1))*np.cos(phi/(n1*(n2-1))+np.pi/n1)
        if i == 0:
            l0_1.set_data(x,y)
        if i == 1:
            l1_1.set_data(x,y)
...
def pin1_update_2(n1,n2,d,D,phi):
    for i in range(int(n1)):   
        #x = (d/2*np.sin(t)+ D/2*np.cos(2*i*np.pi/n))
        #y = (d/2*np.cos(t) + D/2*np.sin(2*i*np.pi/n))
        #x = (d/2*np.sin(t)+ D/2*np.cos(2*i*np.pi/n))*np.cos(np.pi) - (d/2*np.cos(t) + D/2*np.sin(2*i*np.pi/n))*np.sin(np.pi)
        #y = (d/2*np.sin(t)+ D/2*np.cos(2*i*np.pi/n))*np.sin(np.pi) + (d/2*np.cos(t) + D/2*np.sin(2*i*np.pi/n))*np.cos(np.pi)
        x = (d/2*np.sin(t)+ D/2*np.cos(2*i*np.pi/n1))*np.cos(phi/((n1))+np.pi/n1) - (d/2*np.cos(t) + D/2*np.sin(2*i*np.pi/n1))*np.sin(phi/((n1))+np.pi/n1)
        y = (d/2*np.sin(t)+ D/2*np.cos(2*i*np.pi/n1))*np.sin(phi/((n1))+np.pi/n1) + (d/2*np.cos(t) + D/2*np.sin(2*i*np.pi/n1))*np.cos(phi/((n1))+np.pi/n1)
        if i == 0:
            l0_1.set_data(x,y)
        if i == 1:
            l1_1.set_data(x,y)
...
def pin1_update_3(n1,n2,d,D,phi):
    for i in range(int(n1)):   
        '''
...
def update_ehypocycloidA3(e,n1,n2,D,d, phis):
    RD=D/2
    rd=d/2
    rc = (n1-1)*(RD/n1)
    rm = (RD/n1)
...
def update_ehypocycloidA4(e,n1,n2,D,d, phis):
    ...
    x1a = (rc+rm)*np.cos(phis/n1)-e*np.cos((rc+rm)/rm*phis/n1)
    y1a = (rc+rm)*np.sin(phis/n1)-e*np.sin((rc+rm)/rm*phis/n1)

    dx1a = (rc+rm)*(-np.sin(phis/n1)+(e/rm)*np.sin((rc+rm)/rm*phis/n1))
    dy1a = (rc+rm)*(np.cos(phis/n1)-(e/rm)*np.cos((rc+rm)/rm*phis/n1))

    x1 = (x1a + rd/np.sqrt(dx1a**2 + dy1a**2)*(-dy1a))*np.cos(np.pi/n1) - (y1a + rd/np.sqrt(dx1a**2 + dy1a**2)*dx1a)*np.sin(np.pi/n1)+ e*np.cos(phis)
    y1 = (x1a + rd/np.sqrt(dx1a**2 + dy1a**2)*(-dy1a))*np.sin(np.pi/n1) + (y1a + rd/np.sqrt(dx1a**2 + dy1a**2)*dx1a)*np.cos(np.pi/n1)  + e*np.sin(phis)
...
ax_fm = plt.axes([0.25, 0.22, 0.5, 0.015], facecolor=axcolor)
ax_Rm = plt.axes([0.25, 0.20, 0.5, 0.015], facecolor=axcolor)
ax_n = plt.axes([0.25, 0.18, 0.5, 0.015], facecolor=axcolor)
ax_Rd = plt.axes([0.25, 0.16, 0.5, 0.015], facecolor=axcolor)
ax_rd = plt.axes([0.25, 0.14, 0.5, 0.015], facecolor=axcolor)
...
def animate(frame):
    ...
    #pin_update2(sN,sd,sD1,phi)

    #pin1_update_1(sN1,sN,sd,sD1,phi)

    pin1_update_3(sN1,sN,sd,sD1,phi)
    ...
    #update_ehypocycloidA3(se,sN1,sN,sD1,sd, phi)
